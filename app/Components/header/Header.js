...
export default function Header() {
  return (
    ...
    <div className="main-container w-full flex justify-end py-5 bg-[#030127] items-center text-white cursor-pointer">
        <div className="end">
          <Link href="/">
            <span class="text-[20px] mr-[30px] hover:text-white hover:bg-gradient-to-r from-blue-500 to-green-500 active:bg-gradient-to-r from-blue-500 to-green-500 p-[10px] rounded-[10px]">
              Home
            </span>
          </Link>
